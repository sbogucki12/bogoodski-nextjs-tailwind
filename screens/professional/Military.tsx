    ...
    return (
        <div className="flex flex-col bg-secondary h-[600px] items-center justify-center p-6 bg-fixed bg-cover" style={{
            ...
            <div className='text-center '>
                ...
                <p>And as a benefit - to which I'm legitimately grateful, the service provided me some spending money during college.  I didn't use it wisely, but it probably got me through my degree at the University of South Florida.</p>
            </div>
        </div>
    )
}
